...
% Run parameters, check matrix_sizes and then pick the ones you wanne plot!
% choice_sizes_ind = 1:length(matrix_sizes(plot_type));
...
choice_sizes_ind = 1:length(matrix_sizes_for_type);
...
for i = 1:no_algos
    ...
    for k = 1:no_constraints
        ...
        filtered_metrics_const = filter_metrics(plot_type, relevant_metrics, mysize, algo, 1);
