...
To test our algorithms, we generated two datasets: One to test reconstruction performance on the traffic estimation problem and one to evaluate the theoretical guarantees we gave empirically.
\paragraph{Traffic matrices.} 
