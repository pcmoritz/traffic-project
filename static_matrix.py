...
def export_matrices(num_rows, num_cols, num_routes_per_od_pair, num_nonzero_routes_per_o):
  # G = (V,E,w)
  ...
  phi, alpha, mu, f, num_routes = generate_random_matrix(graph, routes,
          sensors, flow_portions)
  scipy.io.savemat('small_graph_random.mat', {'phi': phi, 'real_a': alpha, 'w': mu,
          'f': f, 'num_routes': num_routes}, oned_as='column')
...
#  num_nonzero_routes_per_origin 
  ...
  export_matrices(args.num_rows, args.num_cols, args.num_routes_per_od, args.num_nonzero_routes_per_o)
