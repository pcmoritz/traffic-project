...
matrix_sizes = [2 2 2 2; 2 2 2 3; 2 2 2 4; 3 3 2 2; 3 3 2 3; 3 3 3 4; 4 4 2 2; 4 4 3 3; 4 4 3 4; 5 5 2 2; 5 5 2 3; 5 5 2 4; 5 5 3 2; 5 5 3 3; 5 5 3 4]; % each row is one size triple
sparsity_sizes = [0.028 0.042 0.044 0.067 0.125 0.333];

% Fix sparsity (for various size), size (for various sparsity), model
default_sparsity = .044; default_size = [3 3 2];
